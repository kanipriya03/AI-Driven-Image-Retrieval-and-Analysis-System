  ...
  `,name:e,type:0}}var Ht,Hh,hl,ml,bl,gl,yl,xl,Tl,wl,vl,Il,_l,Ol,Sl=O(()=>{"use strict";Y();be();st();j();Ht=(i,e,o,t=e[0].type,r)=>{let n=i.session.pack?2:0;return{name:o.name,inputNames:["A","B"],inputTypes:[n,n],cacheHint:r,get:()=>Hh(i,e,o,t)}},Hh=(i,e,o,t=e[0].type)=>{let r=i.session.pack?2:0,n=!B.areEqual(e[0].dims,e[1].dims),s=e[0].dims,a=i.session.pack;if(n){let f=$t.calcShape(e[0].dims,e[1].dims,!1);if(!f)throw new Error("Can't perform binary op on the given tensors");s=f;let p=s.length,d=e[0].dims.length!==0?e[0].dims.length:1,y=e[1].dims.length!==0?e[1].dims.length:1,w=e[0].dims.length!==0?"bcastIndices_A(indices, aindices);":"aindices[0] = 0;",v=e[1].dims.length!==0?"bcastIndices_B(indices, bindices);":"bindices[0] = 0;",S=G(i.session.backend.glContext.version),L=a?`
    ...
    `;return{name:o.name,inputNames:["A","B"],inputTypes:[r,r],output:{dims:e[0].dims,type:t,textureType:r},shaderSource:l,hasMain:!0}},hl=(i,e)=>[i.run(Ht(i,e,$h()),e)],ml=(i,e)=>[i.run(Ht(i,e,Gh(),"bool"),e)],bl=(i,e)=>[i.run(Ht(i,e,kh()),e)],gl=(i,e)=>[i.run(Ht(i,e,Ch(),"bool"),e)],yl=(i,e)=>[i.run(Ht(i,e,Nh(),"bool"),e)],xl=(i,e)=>[i.run(Ht(i,e,Rh(),"bool"),e)],Tl=(i,e)=>[i.run(Ht(i,e,Bh()),e)],wl=(i,e)=>[i.run(Ht(i,e,Mh(),"bool"),e)],vl=(i,e)=>[i.run(Ht(i,e,Vh()),e)],Il=(i,e)=>[i.run(Ht(i,e,zh()),e)],_l=(i,e)=>[i.run(Ht(i,e,Fh()),e)],Ol=(i,e)=>[i.run(Ht(i,e,Uh(),"bool"),e)]});var Al,Pl,jh,El=O(()=>{"use strict";Y();Al=(i,e,o)=>(jh(e),[i.cast(e[0],o)]),Pl=i=>_t.tensorDataTypeFromProto(i.attributes.getInt("to")),jh=i=>{if(!i||i.length!==1)throw new Error("Cast requires 1 input.");if(i[0].type==="string")throw new Error("Invalid input type.")}});var Xh,Kh,Dl,Ln,Ll=O(()=>{"use strict";st();j();ue();We();Xh=(i,e)=>({name:"Concat (packed)",inputNames:Array.from({length:i},(o,t)=>`X${t}`),inputTypes:Array(i).fill(2),cacheHint:e}),Kh=(i,e,o,t)=>{let r=o[0].dims.slice();if(t>=r.length||t<-1*r.length)throw new Error("axis specified for concat doesn't match input dimensionality");t<0&&(t=r.length+t);let n=r.slice(0);for(let V=1;V<o.length;V++){let ut=o[V].dims.slice();for(let xt=0;xt<r.length;xt++)if(xt===t)n[t]+=ut[xt];else if(r[xt]!==ut[xt])throw new Error("non concat dimensions must match")}let s=n.length,a=cr("coords",s),u=kt(s),l=le(),f=o.map(V=>V.dims),p=ee(s),d=new Array(f.length-1);d[0]=f[0][t];for(let V=1;V<d.length;V++)d[V]=d[V-1]+f[V][t];let y=p[t],w=p.slice(-2),v=p.join(),S=`if (${y} < ${d[0]}) {
        return getChannel(
            ...
            return getChannel(
              getX${L}(${Ln(p,y,P)}),
              vec2(${Ln(w,y,P)}));`;let A=G(i.session.backend.glContext.version),M=`
          ${l}
...
}`}var ff,cf,Pm,Dm,kn=O(()=>{"use strict";Y();j();ue();He();xi();ff=(i,e,o)=>(Dm(e),i.session.pack?[i.run(Bn(i,e,o),e)]:[i.run(gi(e,o),e)]),cf=i=>pr(i.attributes),Pm=(i,e)=>({name:"MatMul",inputNames:i?["A","B","Bias"]:["A","B"],inputTypes:i?[0,0,0]:[0,0],cacheHint:e});Dm=i=>{if(!i||i.length!==2)throw new Error("MatMul requires 2 inputs.");if(i[0].dims[i[0].dims.length-1]!==i[1].dims[i[1].dims.length-2])throw new Error("shared dimension does not match.");if(i[0].type!=="float32"&&i[0].type!=="float64"||i[1].type!=="float32"&&i[1].type!=="float64")throw new Error("inputs should be float type");if(i[0].type!==i[1].type)throw new Error("inputs types should match")}});function km(i,e,o,t){let r=[],n=[],s=o[0].dims,a=o[1].dims,u=s.length,l=a.length,f=t.length,p=f-u,d=f-l;r=s.map((A,M)=>`coords.${e[M+p]}`),r[u-1]="i*2",r.join(", "),n=a.map((A,M)=>`coords.${e[M+d]}`),n[l-2]="i*2",n.join(", ");let y=$t.getBroadcastDims(s,t),w=$t.getBroadcastDims(a,t),v=y.map(A=>`coords.${e[A+p]} = 0;`).join(`
`),S=w.map(A=>`coords.${e[A+d]} = 0;`).join(`
...
`)},yb=i=>{if(!i||i.length!==1)throw new Error("ImageScaler requires 1 input.");if(i[0].dims.length!==4)throw new Error("Invalid input shape.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")}});var Mf,Uf,Gf,xb,Tb,wb,vb,Ib,_b,Vf=O(()=>{"use strict";st();j();Mf=(i,e,o)=>{_b(e);let t=i.run(Tb(e[0]),e);return[i.run(Ib(i,e[0],o,t.dims),[e[0],t,e[1],e[2]])]},Uf=i=>i.attributes.getFloat("epsilon",1e-5),Gf={name:"InstanceNormalization_MeanAndVariance",inputNames:["X"],inputTypes:[0]},xb=(i,e)=>{let o=e.dims.slice(),t=o[1],r=o[2]*o[3],n=[o[0],t],s=`
    ...
    `;return{...e,output:{dims:n,type:i[0].type,textureType:0},shaderSource:l}},ac=(i,e,o)=>{let t=i[0].dims.slice(),r=Object.hasOwnProperty.call(e,"dilations"),n=e.kernelShape.slice(),s=e.strides.slice(),a=r?e.dilations.slice():[],u=e.pads.slice();Me.adjustPoolAttributes(o,t,n,s,a,u);let l=Me.computePoolOutputShape(o,t,s,a,n,u,e.autoPad),f=Object.assign({},e);return r?Object.assign(f,{kernelShape:n,strides:s,pads:u,dilations:a,cacheKey:e.cacheKey}):Object.assign(f,{kernelShape:n,strides:s,pads:u,cacheKey:e.cacheKey}),[f,l]},Nb={autoPad:"",ceilMode:0,countIncludePad:!1,kernelShape:[],strides:[],pads:[],storageOrder:0,dilations:[],cacheKey:""},Yf={name:"GlobalMaxPool",inputNames:["X"],inputTypes:[0]},sc=(i,e)=>(Nn(e),[i.run({...Yf,get:()=>ic(e,Yf,!0,Nb)},e)]),Nn=i=>{if(!i||i.length!==1)throw new Error("Pool ops requires 1 input.");if(i[0].type!=="float32"&&i[0].type!=="float64")throw new Error("Invalid input type.")},uc=(i,e,o,t,r)=>{let n=i.length;if(e.kernelShape.length<=2){let s=e.kernelShape[e.kernelShape.length-1],a=e.strides[e.strides.length-1],u=e.pads[e.pads.length/2-1],l=e.pads[e.pads.length-1],f=i[n-1],p="",d="",y="";if(u+l!==0?p=`
      ...
      `}else{let s=B.size(e.kernelShape),a=B.computeStrides(e.kernelShape),u=a.length,l=e.pads.length,f=Rb(u),p=Cn(i,"inputDims"),d=Cn(e.pads,"pads"),y=Cn(a,"kernelStrides"),w=Cn(e.strides,"strides"),v=e.pads.reduce((P,A)=>P+A),S="";return v?S=`
...
value = _A(inputIdx);`,"value = min(value, _A(inputIdx));",""]}),hc=(i,e,o)=>je(i,e,o,"ReduceProd",()=>["value = 1.0;","value *= _A(inputIdx);",""]),mc=(i,e,o)=>je(i,e,o,"ReduceLogSum",()=>["value = 0.0;","value += _A(inputIdx);","value = log(value);"]),bc=(i,e,o)=>je(i,e,o,"ReduceLogSumSquare",()=>["float t; value = 0.0;","t = _A(inputIdx); value += t * t;",""])});var yc,xc=O(()=>{"use strict";Y();yc=(i,e)=>{let o=B.calculateReshapedDims(e[0].dims,e[1].integerData);return i.session.pack?[i.reshapePacked(e[0],o)]:[i.reshapeUnpacked(e[0],o)]}});var Tc,Si,wc,vc,Gr,Ub,Ai,Rn,Pi=O(()=>{"use strict";vt();st();j();Tc={name:"Upsample",inputNames:["X"],inputTypes:[0]},Si=(i,e,o)=>(Ai(e,o),[i.run({...Tc,cacheHint:o.cacheKey,get:()=>Ub(i,e,o)},e)]),wc=i=>Gr(i,7),vc=i=>Gr(i,9),Gr=(i,e)=>{let o=e>=10,t=i.attributes.getString("mode","nearest");if(t!=="nearest"&&t!=="linear"&&(e<11||t!=="cubic"))throw new Error(`unrecognized mode: ${t}`);let r=[];e<9&&(r=i.attributes.getFloats("scales"),Rn(r,t,o));let n=i.attributes.getFloat("extrapolation_value",0),s=e>10?i.attributes.getString("coordinate_transformation_mode","half_pixel"):"asymmetric";if(["asymmetric","pytorch_half_pixel","tf_half_pixel_for_nn","align_corners","tf_crop_and_resize","half_pixel"].indexOf(s)===-1)throw new Error(`coordinate_transform_mode '${s}' is not supported`);let a=s==="tf_crop_and_resize",u=a,l=t==="nearest"&&e>=11?i.attributes.getString("nearest_mode","round_prefer_floor"):"";if(["round_prefer_floor","round_prefer_ceil","floor","ceil",""].indexOf(l)===-1)throw new Error(`nearest_mode '${l}' is not supported`);let f=i.attributes.getFloat("cubic_coeff_a",-.75),p=i.attributes.getInt("exclude_outside",0)!==0;if(p&&t!=="cubic")throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");let d=e<11?!0:t==="nearest"&&s==="asymmetric"&&l==="floor",y=0,w=0,v=0;return e>10?i.inputs.length>2?(y=1,w=2,v=3):(w=1,v=2):e===9&&(w=1),W({opset:e,isResize:o,mode:t,scales:r,extrapolationValue:n,coordinateTransformMode:s,useExtrapolation:u,needRoiInput:a,nearestMode:l,cubicCoefficientA:f,excludeOutside:p,useNearest2xOptimization:d,roiInputIdx:y,scalesInputIdx:w,sizesInputIdx:v})},Ub=(i,e,o)=>{let t=G(i.session.backend.glContext.version),[r,n]=i.calculateTextureWidthAndHeight(e[0].dims,0),s=e[0].dims.map((v,S)=>Math.floor(v*o.scales[S])),[a,u]=i.calculateTextureWidthAndHeight(s,0),l=s.length,f=new Array(l),p=new Array(l),d=`
    ...
    float process(int indices[2]) {
      ...
      return y0 + float(x_offset) * (y1 - y0) / float(scales[1]);
                ...
                `;break;default:throw new Error(`resize (packed) does not support coordinateTransformMode:                                 '${o.coordinateTransformMode}'`)}let S=kt(a),L=le(),P=`
...
`);let L="";p<2&&f>0?L="coords":L=s.map((Et,It)=>`coords.${S[It+w]}`).join(", ");let P="return outputValue;",M=B.size(s)===1,ut=B.size(a)===1;if(f===1&&!M&&!ut)P=`
        return vec4(outputValue.xy, outputValue.xy);
      `;else if(M&&!ut)p===1?P=`
          return vec4(outputValue.x, outputValue.x, 0., 0.);
        `:P=`
          return vec4(outputValue.x);
        `;else if(d.length){let Et=f-2,It=f-1;d.indexOf(Et)>-1&&d.indexOf(It)>-1?P="return vec4(outputValue.x);":d.indexOf(Et)>-1?P="return vec4(outputValue.x, outputValue.y, outputValue.x, outputValue.y);":d.indexOf(It)>-1&&(P="return vec4(outputValue.xx, outputValue.zz);")}let xt=`
...
`);let P="";l<2&&u>0?P="coords":P=t.unpackedShape.map((M,V)=>`coords.${L[V+v]}`).join(", ");let A=`
      ...
      vec2 uv = packedUVfrom3D(
        ${f}, ${l}, ${d}, ${p}, b, row, col);
      return ${u.texture2D}(${t}, uv);}`;return new k(w,["coordinates.packedUVfrom3D"])}getPackedSamplerND(o,t,r){let n=r.unpackedShape,s=n.length,a=[r.width,r.height],u=G(this.context.glContext.version),l=[a[0],a[1]],f=l[1],p=l[0],d=Math.ceil(n[s-1]/2),y=d*Math.ceil(n[s-2]/2),w="int b, int row, int col",v=`b * ${y} + (row / 2) * ${d} + (col / 2)`;for(let P=2;P<s-1;P++)w=`int b${P}, `+w,y*=n[s-P-1],v=`b${P} * ${y} + `+v;let L=`vec4 ${o}(${w}) {
      int index = ${v};
      int texR = index / ${p};
      ...
      `;return new k(d,["coordinates.uvFromFlat","coordinates.sampleTexture","coordinates.coordsToOffset"])}getUnpackedSampler3D(o,t,r){let n=r.unpackedShape,s=n[1]*n[2],a=n[2],{newShape:u,keptDims:l}=hr(n),f=u;if(f.length<n.length){let w=lr(n,f),v=["batch","col","row"],S=JSON.parse(JSON.stringify(r));S.unpackedShape=w;let L=this.getUnpackedSamplerFromInput(o,t,S),P=l.reverse(),A=`
          ${L.routineBody}
      ...
      `;return new k(p,["coordinates.uvFromFlat","coordinates.sampleTexture"])}getUnpackedSampler5D(o,t,r){let n=r.unpackedShape,s=n[4],a=n[3]*s,u=n[2]*a,l=n[1]*u,{newShape:f,keptDims:p}=hr(n);if(f.length<n.length){let v=lr(n,f),S=["row","col","depth","depth2","depth3"],L=JSON.parse(JSON.stringify(r));L.unpackedShape=v;let P=`
        ...
        `;return new k(P,["coordinates.sampleTexture","coordinates.uvFromFlat"])}let d=r.width,y=r.height,w=`
        float ${o}(int row, int col, int depth, int depth2, int depth3) {
      ...
      `;return new k(w,["coordinates.sampleTexture","coordinates.uvFromFlat"])}getUnpackedSampler6D(o,t,r){let n=r.unpackedShape,s=n[5],a=n[4]*s,u=n[3]*a,l=n[2]*u,f=n[1]*l,{newShape:p,keptDims:d}=hr(n);if(p.length<n.length){let S=lr(n,p),L=["row","col","depth","depth2","depth3","depth4"],P=JSON.parse(JSON.stringify(r));P.unpackedShape=S;let A=`
          ...
          `;return new k(A,["coordinates.sampleTexture","coordinates.uvFromFlat"])}let y=r.width,w=r.height,v=`
          float ${o}(int row, int col, int depth,
            int depth2, int depth3, int depth4) {
